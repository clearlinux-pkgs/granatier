...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/granatier-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/granatier-23.08.5.tar.xz.sig
...
%prep
%setup -q -n granatier-23.08.5
cd %{_builddir}/granatier-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708398469
mkdir -p clr-build
pushd clr-build
