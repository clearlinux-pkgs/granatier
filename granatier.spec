...
Version  : 24.02.1
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.02.1/src/granatier-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/granatier-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/granatier-24.02.1.tar.xz.sig
...
%prep
%setup -q -n granatier-24.02.1
cd %{_builddir}/granatier-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711074650
mkdir -p clr-build
pushd clr-build
