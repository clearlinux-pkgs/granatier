...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/granatier-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/granatier-24.12.3.tar.xz.sig
...
%setup -q -n granatier-24.12.3
cd %{_builddir}/granatier-24.12.3
pushd ..
cp -a granatier-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742460808
mkdir -p clr-build
pushd clr-build
