...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/granatier-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/granatier-24.12.1.tar.xz.sig
...
%setup -q -n granatier-24.12.1
cd %{_builddir}/granatier-24.12.1
pushd ..
cp -a granatier-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736533291
mkdir -p clr-build
pushd clr-build
