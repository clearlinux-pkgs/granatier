...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/granatier-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/granatier-24.05.2.tar.xz.sig
...
%setup -q -n granatier-24.05.2
cd %{_builddir}/granatier-24.05.2
pushd ..
cp -a granatier-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720558376
mkdir -p clr-build
pushd clr-build
